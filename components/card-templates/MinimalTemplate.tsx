...
export function MinimalTemplate({ profile, cardUrl }: { profile: Profile; cardUrl?: string }) {
  ...
  return (
    <div className="bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 rounded-2xl shadow-xl p-8 md:p-12">
      <div className="text-center mb-8">
        ...
        {profile.bio && (
          <p className="text-gray-600 dark:text-gray-400 max-w-xl mx-auto">{profile.bio}</p>
        )}
      </div>
